...
if not DS_BW then
	...
	DS_BW.version = "1.5.13" -- this one is used for the welcoming message mainly. if you update DSBW's code to your liking, please update this value to something like "HOMEBREW" :)
